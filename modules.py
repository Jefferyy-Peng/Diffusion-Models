...
class DoubleConv(nn.Module):
    def __init__(self, in_channels, out_channels, mid_channels=None, residule=False):
        super().__init__()
...
class Down(nn.Module):
    def __init__(self, in_channels, out_channels, emb_dim=256):
        ...
        self.maxpool_conv = nn.Sequential(
            nn.MaxPool2d(2),
            DoubleConv(in_channels, in_channels, residule=True),
...
class SelfAttention(nn.Module):
    def __init__(self, emb_dim, size):
        super().__init__()
...
class UNet(nn.Module):
    def __init__(self, c_in=3, c_out=3, time_dim=256, device='cuda'):
        ...
        self.outc = nn.Conv2d(64, c_out, kernel_size=(1,1))
